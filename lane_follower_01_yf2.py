...
class LaneFollower:
    ...
    def lane_lines(self, image, lines):
        ...
        """
        left_lane, right_lane = self.average_slope_intercept(lines, image)
        y1 = image.shape[0]
        y2 = y1 * 0.6
    ...
    def average_slope_intercept(self, lines, image):
        ...
        for line in lines:
            ...
            if x1 < half_x or x2 < half_x:
                lines_left.append(line)
            else:
                lines_right.append(line)

        for lline in lines_left:
            for x1, y1, x2, y2 in lline:
                if x1 == x2:
                    continue
        ...
        for rline in lines_right:
            for x1, y1, x2, y2 in rline:
                if x1 == x2:
                    continue
